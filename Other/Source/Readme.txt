...
user in an INI file next to ScannerPortable.exe called ScannerPortable.ini.
...
copy AppNamePortable.ini from this directory to ScannerPortable.ini next to
ScannerPortable.exe. The options in the INI file are as follows:
